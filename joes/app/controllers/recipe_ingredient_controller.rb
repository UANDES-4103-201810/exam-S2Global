class RecipeIngredientsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @recipe_ingredient.save
        format.html { redirect_to @recipe_ingredient, notice: 'RecipeIngredient was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @recipe_ingredient.update(recipe_ingredient_params)
        format.html { redirect_to @recipe_ingredient, notice: 'RecipeIngredient was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to recipe_ingredients_url, notice: 'RecipeIngredient was successfully destroyed.' }
  ...
  def recipe_ingredient_params
    params.require(:recipe_ingredient).permit(:recipe_id_id, :ingredient_id_id)
  end
end