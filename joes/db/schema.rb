...
ActiveRecord::Schema.define(version: 2018_06_20_194730) do
  ...
  create_table "pizzas", force: :cascade do |t|
    t.integer "crust_id_id"
    t.integer "recipe_id_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["crust_id_id"], name: "index_pizzas_on_crust_id_id"
    t.index ["recipe_id_id"], name: "index_pizzas_on_recipe_id_id"
  end
